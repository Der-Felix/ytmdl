...
2. **SemVer Comparison:** The installed version (e.g. `0.26.0`) is compared against the latest stable release tag using strict Semantic Versioning. Pre-releases and drafts are filtered out.
