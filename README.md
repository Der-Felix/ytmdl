...
curl -fsSL -O https://raw.githubusercontent.com/Der-Felix/ytmdl/v0.25.0/compose.ghcr.yaml
curl -fsSL -O https://raw.githubusercontent.com/Der-Felix/ytmdl/v0.25.0/.env.example
cp .env.example .env
```
...
```sh
podman pull ghcr.io/der-felix/ytmdl-backend:0.25.0
podman pull ghcr.io/der-felix/ytmdl-frontend:0.25.0
```
