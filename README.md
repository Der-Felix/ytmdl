...
curl -fsSL -O https://raw.githubusercontent.com/Der-Felix/ytmdl/v0.17.2/compose.ghcr.yaml
curl -fsSL -O https://raw.githubusercontent.com/Der-Felix/ytmdl/v0.17.2/.env.example
cp .env.example .env
```
